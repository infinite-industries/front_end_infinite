<template>
  <div>
    ...
    <input ref="hourInput" :disabled="!date" v-model="hour" type="text" min="0" max="23" placeholder="hh" @keyup="checkForFocusOutHour" :class="{ 'invalid' : this.invalid_hour }" maxlength="2"></input>
    <span>:</span>
    <input ref="minInput" :disabled="!date" v-model="minute" type="text" min="0" max="59" placeholder="mm" @keyup="checkForFocusOutMin" :class="{ 'invalid' : this.invalid_min }" maxlength="2"></input>
